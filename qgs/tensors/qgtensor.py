...
class QgsTensorT4(QgsTensor):
    """qgs :math:`T^4` tendencies tensor class.
...
if __name__ == '__main__':
    ...
    # aip.connect_to_ocean(oip)
    # agotensor = QgsTensor(pars, aip, oip)
    ...
    # aip = AtmosphericSymbolicInnerProducts()
    # oip = OceanicSymbolicInnerProducts()
    aip = AtmosphericSymbolicInnerProducts(pars, quadrature=True)  # , stored=False)
    oip = OceanicSymbolicInnerProducts(pars, quadrature=True)  # , stored=False)
